# Generated by Django 4.2 on 2023-05-05 01:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-rocket', 'Foguete'), ('lni-laptop-phone', 'NoteBook'), ('lni-cog', 'Engrenagem'), ('lni-leaf', 'Folha'), ('lni-layers', 'Papel'), ('lni-leaf', 'Folha')], max_length=20, verbose_name='Icone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', stdimage.models.StdImageField(force_min_size=False, upload_to=negocios.models.get_file_path, variations={'thumb': {'crop': True, 'height': 480, 'width': 480}}, verbose_name='Imagem')),
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='negocios.cargo', verbose_name='Cargo')),
            ],
            options={
