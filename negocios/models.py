...
class Base(models.Model):
    criados = models.DateField('Criação', auto_now_add=True) # adicionando automaticamente a data de criação (só colodado na adição, quando novo for criado)
    modificado = models.DateField('Atualização', auto_now=True) #quando for atualizado será modificado automanticamente
...
class Servico(Base):
    ...
    def __str__(self): #apresentando o objeto
        return self.servico
